...
<tr>
<td rowspan="1" colSpan="2" >**生命周期相关接口**</td>
</tr>
...
<tr>
<td rowspan="1" colSpan="2" >**音视频流控制接口**</td>
</tr>
...
<tr>
<td rowspan="1" colSpan="2" >**云端应用交互接口**</td>
</tr>
...
<tr>
<td rowspan="1" colSpan="2" >**云端外设交互​接口**</td>
</tr>
...
启动会话（access），建立与云手机的连接。在本地会话对象初始化成功后（参见[创建会话]()），调用此方法，以建立和指定 Id 的云手机的连接。在调用此方法之前，需要在 [init()]() 方法的 TcrConfig 内传入正确的 accessToken 或者调用了 [setAccessToken()]()。
