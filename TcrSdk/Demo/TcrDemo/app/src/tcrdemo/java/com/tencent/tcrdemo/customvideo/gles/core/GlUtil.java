...
package com.tencent.tcrdemo.customvideo.gles.core;
...
//public static final String TAG = "Grafika";
     ...
     * @return the float [ ]
     */
    public static float[] changeMVPMatrix(float[] mvpMatrix, float viewWidth, float viewHeight, float textureWidth,
            float textureHeight) {
