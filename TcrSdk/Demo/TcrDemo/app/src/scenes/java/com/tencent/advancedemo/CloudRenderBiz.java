...
import com.tencent.advancedemo.data.Request;
import com.tencent.advancedemo.data.StartGameRequest;
import com.tencent.advancedemo.data.StartProjectRequest;
import com.tencent.advancedemo.data.StopGameRequest;
import com.tencent.advancedemo.data.StopProjectRequest;
...
public class CloudRenderBiz {
     ...
     */
    public static final String EXPERIENCE_CODE = "49GTGD6L";
    /**
    ...
    private static JsonObjectRequest createRequest(String requestAddress, Request param, Listener<JSONObject> listener,
    ...
    public void startGame(String clientSession, Listener<JSONObject> listener, ErrorListener errorListener) {
        StartGameRequest param = new StartGameRequest(mUserID,GAME_ID,clientSession);
        JsonObjectRequest request = createRequest(SERVER_URL, param, listener, errorListener);
        mQueue.add(request);
    }
    ...
    public void stopGame(Listener<JSONObject> listener, ErrorListener errorListener) {
        StopGameRequest param = new StopGameRequest(mUserID);
        JsonObjectRequest request = createRequest(SERVER_URL , param, listener, errorListener);
        mQueue.add(request);
    }
