...
GAME_PARAS为**可选**内容，作为云游戏启动的附加参数，一版用于传递云端游戏初始化配置参数。
...
第一步，安装java11环境，下载[补丁包生成工具](../Tools)，将Tools文件夹中的[release.keystore](../Tools/release.keystore)替换为您的签名文件，
